...
function G.UIDEF.use_and_sell_buttons(card)
	...
	if card.config.center.mod == SynthB.mod and (card.area == G.jokers and G.jokers and card.config.center.use) and not card.debuff and card.config.center.set == "Joker" and (not card.config.center.needs_use_button or card.config.center:needs_use_button(card)) then
