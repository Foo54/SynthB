...
--- @param card Card|Tag the card the info_queue is attached to
---@param key string the key found within descriptions.SongInfo
---@param vars? table any vars needed for the ui
function SynthB.song_info(info_queue, card, key, vars)
---@diagnostic disable-next-line: undefined-field
	if SynthB.mod.config.display_misc_info or SynthB.mod.config.display_song_info and not card.fake_card then
